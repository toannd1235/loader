...
.loader::after {
  ...
  border-radius: 50%;
  border: 3px solid;
  border-color: #1ea1f2 transparent;
}
...
.loader::after {
  ...
  margin: auto;
  border: 3px solid;
  border-color: transparent #1ea1f2 #1ea1f2;
  width: 24px;
  height: 24px;
  border-radius: 50%;
...
.loader::before {
  ...
  margin: auto;
  border: 3px solid;
  border-color: transparent transparent #1ea1f2 #1ea1f2;
  width: 40px;
  height: 40px;
  border-radius: 50%;
  box-sizing: border-box;
...
`.loader {
  ...
  display: inline-block;
  position: relative;
  background: linear-gradient(0deg, rgba(255, 61, 0, 0.2) 33%, #1ea1f2 100%);
  box-sizing: border-box;
  animation: rotation 1s linear infinite;
}
.loader::after {
...
.loader::after {
  ...
  height: 48px;
  border-radius: 50%;
  border-bottom: 4px solid #1ea1f2;
...
`.loader {
  ...
  border-color: #1ea1f2 #1ea1f2 transparent #1ea1f2;
  border-radius: 50%;
  display: inline-block;
  position: relative;
  box-sizing: border-box;
...
.loader::after {
  ...
  top: 50%;
  border: 12px solid;
  border-color: transparent #1ea1f2 #1ea1f2 transparent;
  transform: translate(-50%, -50%);
  border-radius: 50%;
}
...
@keyframes shadowPulse {
  33% {
    background: #FFF;
    box-shadow: -24px 0 #1ea1f2, 24px 0 #FFF;
  }
  66% {
    background: #1ea1f2;
    box-shadow: -24px 0 #FFF, 24px 0 #FFF;
  ...
  100% {
    background: #FFF;
    box-shadow: -24px 0 #FFF, 24px 0 #1ea1f2;
  }
}
`
  },
...
`.loader {
  ...
  position: relative;
  background-color: #FFF;
  background: radial-gradient(ellipse at center, #1ea1f2 0%, #1ea1f2 14%, #FFF 15%, #FFF 100%);
...
`.loader {
  ...
  position: relative;
  box-shadow: 0px 0px #1ea1f2 inset;
  background-image: linear-gradient(#1ea1f2 100px, transparent 0);
...
`
  ...
  background-color: #FFF;
  background-image: radial-gradient(ellipse at center, #FFF 34%, #1ea1f2 35%, #1ea1f2 54%, #FFF 55%), linear-gradient(#1ea1f2 10px, transparent 0);
...
.loader::before {
  ...
  height: 44px;
  border-radius: 50%;
  box-shadow: 0px 15px #1ea1f2 inset;
  top: 67px;
}
.loader::after {
  content: '';  
